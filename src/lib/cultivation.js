...
export const LIFE_LAMPS = [
  ...
  },
  {
    ...
    shortName: 'Ma Tôn Đăng',
    tier: 'than_pham',
    icon: '🔮',
    color: '#ef4444',
    desc: 'Chứa đựng sức mạnh Ma Tôn chí cao từ thời vạn cổ, chấn áp cửu u bát hoang ma giới.',
    poem: 'Vô cực ma tôn, vạn ma quy phục.',
  },
  {
    id: 'khai_thien_tich_dia',
    name: 'Khai Thiên Tích Địa Đăng',
    shortName: 'Khai Thiên Đăng',
    tier: 'than_pham',
    icon: '📜',
    color: '#ef4444',
    desc: 'Sức mạnh xẻ trời lấp biển ngưng tụ từ ngọn hỏa hồng mông khi khai thiên tích địa.',
    poem: 'Khai thiên tích địa, định càn khôn vũ trụ.',
  },
  {
  ...
  },
  {
    ...
    icon: '⏳',
    color: '#ef4444',
    desc: 'Nắm giữ sức mạnh bất hủ vượt qua mọi cấm chế của dòng sông thời gian và không gian.',
    poem: 'Bất hủ thời không, ngạo thị tuế nguyệt.',
  },
  {
