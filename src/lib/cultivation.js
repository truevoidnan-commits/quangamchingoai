...
export const SUPPRESSING_ARTIFACTS = [
  ...
  { id: 'than_linh_tan_dien_quan', name: 'Thần Linh Tàn Diện Chi Đồng', shortName: 'Tàn Diện Chi Đồng', tier: 'than_pham', type: 'Thần Tinh Đồng Cốt', icon: '👁️', color: '#ef4444', desc: 'Tàn đồng của Thần Linh thái cổ rơi rụng, ngưng tụ thần tính tối thượng trấn áp vạn cổ.', poem: 'Thần đồng hạ lâm, vạn đạo quy phục.' },
  { id: 'dai_hong_thoi_quang_xa', name: 'Đại Hồng Thời Quang Sa Khí', shortName: 'Thời Quang Sa', tier: 'than_pham', type: 'Thời Gian Bản Nguyên', icon: '⏳', color: '#ef4444', desc: 'Luồng cát thời gian từ Đại Hồng nguyên thủy, có thể tua ngược khoảnh khắc trước khi thiên cung tổn hại.', poem: 'Thời quang nghịch lưu, vĩnh hằng bất diệt.' },
  { id: 'thai_co_trong_dong_hoang_an', name: 'Thái Cổ Trọng Đồng Hoàng Ấn', shortName: 'Trọng Đồng Hoàng Ấn', tier: 'than_pham', type: 'Cổ Hoàng Chí Bảo', icon: '🔱', color: '#ef4444', desc: 'Ấn tỷ của Cổ Hoàng mang sức mạnh Trọng Đồng chí tôn, trấn áp mười phương thế giới.', poem: 'Trọng đồng hoàng ấn, vạn giới xưng tôn.' },
  { id: 'cuc_canh_nghich_menh_thien_thu', name: 'Cực Cảnh Nghịch Mệnh Thần Thư', shortName: 'Cực Cảnh Thần Thư', tier: 'than_pham', type: 'Cực Cảnh Thần Thư', icon: '📜', color: '#ef4444', desc: 'Cuốn sách trời mở ra bí mật phá vỡ cực hạn của sinh mệnh và quy tắc thiên đạo.', poem: 'Cực cảnh thần thư, cải biến thiên mệnh.' },
  { id: 'bat_diet_than_quyen_phu', name: 'Bất Diệt Thần Quyến Hộ Thân Phù', shortName: 'Thần Quyến Phù', tier: 'than_pham', type: 'Thần Quyến Tối Thượng', icon: '🌟', color: '#ef4444', desc: 'Lá phù mang chúc phúc tối cao của Thần Linh, vĩnh viễn bảo hộ linh hồn và đan điện bất tử.', poem: 'Thần quyến vô thượng, vạn kiếp trường tồn.' },
  { id: 'chu_thien_tich_diet_ma_kiem', name: 'Chư Thiên Tịch Diệt Ma Kiếm', shortName: 'Tịch Diệt Ma Kiếm', tier: 'than_pham', type: 'Hủy Diệt Ma Kiếm', icon: '⚔️', color: '#ef4444', desc: 'Thanh ma kiếm mang theo ngày tận thế của chư thiên, trảm diệt mọi đối thủ dám khinh nhờn đạo uy.', poem: 'Tịch diệt ma kiếm, vạn giới quy tịch.' },
  { id: 'van_gioi_khoi_nguyen_hoa', name: 'Vạn Giới Khởi Nguyên Hỗn Độn Hoa', shortName: 'Hỗn Độn Hoa', tier: 'than_pham', type: 'Khởi Nguyên Thần Hoa', icon: '🪷', color: '#ef4444', desc: 'Bông hoa nở ra từ thuở hồng mông sơ khai, mỗi cánh hoa chứa đựng một vũ trụ hoàn chỉnh.', poem: 'Khởi nguyên thần hoa, bao la vạn giới.' },
  { id: 'toi_cao_thien_menh_ngoc_ty', name: 'Tối Cao Thiên Mệnh Hoàng Cực Tỷ', shortName: 'Hoàng Cực Tỷ', tier: 'than_pham', type: 'Thiên Mệnh Chi Bảo', icon: '👑', color: '#ef4444', desc: 'Bảo vật thiên mệnh cai quản luật nhân quả và quy tắc vận hành của toàn cõi thiên địa.', poem: 'Thiên mệnh sở quy, vạn cổ bất hủ.' },
];
