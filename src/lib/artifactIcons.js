...
export const THAN_PHAM_AI_ICONS = {
  ...
  hoang_tuyen_dinh_hai_binh: baseUrl + 'icons/than_pham/hoang_tuyen_dinh_hai_binh.jpg',
  nam_minh_than_hoa_dinh:   baseUrl + 'icons/than_pham/nam_minh_than_hoa_dinh.jpg',
  kim_o_than_tien_cung:     baseUrl + 'icons/than_pham/kim_o_than_tien_cung.jpg',
  bach_ngoc_truong_sinh_thu: baseUrl + 'icons/than_pham/bach_ngoc_truong_sinh_thu.jpg',
  tu_nguyet_phe_hon_kich:   baseUrl + 'icons/than_pham/tu_nguyet_phe_hon_kich.jpg',
  hac_thien_de_long_bao:    baseUrl + 'icons/than_pham/hac_thien_de_long_bao.jpg',
  thanh_lam_tran_the_tram:  baseUrl + 'icons/than_pham/thanh_lam_tran_the_tram.jpg',
};
...
export const LAMP_THAN_PHAM_AI_ICONS = {
  ...
  than_linh_tan_dien:           baseUrl + 'icons/than_pham/lamp_than_linh_tan_dien.jpg',
  dai_hong_thoi_quang:          baseUrl + 'icons/than_pham/lamp_dai_hong_thoi_quang.jpg',
  thai_co_trong_dong_hoang:     baseUrl + 'icons/than_pham/lamp_thai_co_trong_dong_hoang.jpg',
  cuc_canh_nghich_menh:         baseUrl + 'icons/than_pham/lamp_cuc_canh_nghich_menh.jpg',
  bat_diet_than_quyen:          baseUrl + 'icons/than_pham/lamp_bat_diet_than_quyen.jpg',
  chu_thien_tich_diet:          baseUrl + 'icons/than_pham/lamp_chu_thien_tich_diet.jpg',
};
