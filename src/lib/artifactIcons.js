...
// Lightweight Vite Asset Mapping (Super Fast, Content Hashed, Cached)
// =========================================================================
...
export const THAN_PHAM_AI_ICONS = {
  ...
  thao_tu_kiem_quyet:           bundledIcons['art_thao_tu_kiem_quyet'] || '',
  ...
  trung_dong:                   bundledIcons['art_trung_dong'] || '',
  ...
  tam_thu_dao:                  bundledIcons['art_tam_thu_dao'] || '',
...
export const LAMP_THAN_PHAM_AI_ICONS = {
  ...
  chung_yen_tich_diet:          bundledIcons['lamp_chung_yen_tich_diet'] || '',
